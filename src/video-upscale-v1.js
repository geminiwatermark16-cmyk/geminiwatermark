...
if (!tabs || document.getElementById('upscaleTab')) {
  ...
  style.textContent = `
    ...
    @media(max-width:760px){#tool .tabs{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)}#tool .tabs button{min-width:0;white-space:normal}.gwUpscaleTab{grid-column:1/-1}.gwUpscalePanel{padding:18px 14px}.gwUpscaleHero{display:block}.gwUpscalePill{display:inline-flex;margin-top:13px}.gwUpscalePreviewGrid{grid-template-columns:1fr}.gwUpscaleDropzone{min-height:210px}.gwUpscaleActions{justify-content:stretch}.gwUpscaleActions button{flex:1 1 100%}}
  `;
